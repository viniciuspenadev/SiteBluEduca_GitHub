...
<body class="selection:bg-[#0c46e6] selection:text-white">
    ...
    <nav class="fixed z-50 w-full top-0 md:top-6 px-4">
        <div class="max-w-5xl mx-auto bg-white/80 backdrop-blur-xl border border-slate-200 rounded-full px-8 py-3 flex items-center justify-between shadow-2xl shadow-blue-500/5">
            <a href="index.php" class="flex items-center gap-2">
                <i data-lucide="graduation-cap" class="w-8 h-8 text-[#0c46e6]"></i>
                <span class="font-bold text-2xl text-[#0000bf] tracking-tight">Blu<span class="text-blue-600">Educa</span></span>
            </a>
            <div class="hidden md:flex items-center gap-6">
                <a href="index.php" class="text-sm font-bold text-slate-600 hover:text-[#0c46e6] transition-all">Home</a>
                <a href="#precos" class="text-sm font-bold text-[#0c46e6]">Preços</a>
                <a href="#comparativo" class="text-sm font-bold text-slate-600 hover:text-[#0c46e6] transition-all">Comparativo</a>
            </div>
            <a href="#contato" class="btn-primary px-6 py-2.5 rounded-full text-sm font-bold shadow-lg shadow-blue-500/20">Fale Conosco</a>
        </div>
    </nav>
    ...
    <main class="w-full pt-44 pb-32">
        ...
        <section class="max-w-3xl mx-auto px-4 mb-24 reveal" style="transition-delay: 0.1s;">
            <div class="bg-slate-50 border border-slate-200 p-8 rounded-[2rem] text-center shadow-sm">
                <p class="text-sm font-bold text-slate-500 uppercase tracking-widest mb-6">Quantos alunos sua escola possui?</p>
                ...
                <input type="range" id="student-slider" min="50" max="2000" step="50" value="250" class="w-full h-2 bg-slate-200 rounded-lg appearance-none cursor-pointer">
        ...
        <section id="precos" class="max-w-7xl mx-auto px-4 mb-32">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <!-- PLANO BÁSICO -->
                <div class="tech-card p-10 flex flex-col relative reveal" id="card-basic" style="transition-delay: 0.2s;">
                    <div class="mb-8">
                        <span class="text-orange-500 font-extrabold text-xs uppercase tracking-widest mb-2 block">Básico</span>
                        <h3 class="text-3xl font-black text-slate-900 mb-4">Comunicação</h3>
                        <p class="text-sm text-slate-500 leading-relaxed">Ideal para começar a digitalizar sua escola.</p>
                    </div>
                    ...
                    <div class="border-t border-slate-100 pt-8">
                        <div class="mb-6">
                            <p class="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-1">Limite do Plano</p>
                            <p class="text-sm font-bold text-slate-700">Até 150 alunos</p>
                        </div>
                        <a href="https://wa.me/5500000000000" class="block text-center border-2 border-slate-200 py-4 rounded-xl font-bold text-slate-700 hover:border-slate-900 transition-all">Fale conosco</a>
                    </div>
                </div>

                <!-- PLANO PADRÃO -->
                <div class="tech-card p-10 flex flex-col relative featured reveal" id="card-standard" style="transition-delay: 0.3s;">
                    <div class="plan-badge">RECOMENDADO</div>
                    <div class="mb-8">
                        <span class="text-[#0c46e6] font-extrabold text-xs uppercase tracking-widest mb-2 block">Padrão</span>
                    ...
                    <div class="border-t border-slate-100 pt-8">
                        ...
                        <a href="https://wa.me/5500000000000" class="block text-center bg-[#0c46e6] py-4 rounded-xl font-bold text-white shadow-xl shadow-blue-500/30 hover:bg-blue-700 transition-all">Fale conosco</a>
                    </div>
                </div>

                <!-- PLANO AVANÇADO -->
                <div class="tech-card p-10 flex flex-col relative reveal" id="card-advanced" style="transition-delay: 0.4s;">
                    <div class="mb-8">
                        <span class="text-blue-400 font-extrabold text-xs uppercase tracking-widest mb-2 block">Avançado</span>
                    ...
                    <div class="border-t border-slate-100 pt-8">
                        ...
                        <a href="https://wa.me/5500000000000" class="block text-center border-2 border-slate-900 py-4 rounded-xl font-bold text-slate-900 hover:bg-slate-900 hover:text-white transition-all">Fale conosco</a>
                    </div>
                </div>

                <!-- PLANO ENTERPRISE -->
                <div class="tech-card p-10 flex flex-col relative bg-slate-900 text-white reveal" style="transition-delay: 0.5s;">
                    ...
                    <div class="mb-8 text-center">
                        <span class="text-blue-400 font-extrabold text-xs uppercase tracking-widest mb-2 block">Enterprise</span>
                    ...
                    <a href="https://wa.me/5500000000000" class="block text-center bg-white py-4 rounded-xl font-bold text-slate-900 hover:bg-slate-100 transition-all mt-auto">Consultar</a>
                </div>
            </div>
        </section>
                ...
                <table class="w-full text-left border-collapse min-w-[800px]">
                    <thead>
                        <tr class="bg-white">
                            ...
                            <th class="p-8 text-center">
                                ...
                                <a href="#" class="inline-block border border-orange-200 text-orange-600 px-6 py-2 rounded-full text-xs font-bold hover:bg-orange-50 transition-all">Fale conosco</a>
                            </th>
                            <th class="p-8 text-center">
                                <p class="text-red-500 font-extrabold text-xs uppercase mb-2">Padrão</p>
                                <a href="#" class="inline-block border border-red-200 text-red-600 px-6 py-2 rounded-full text-xs font-bold hover:bg-red-50 transition-all">Fale conosco</a>
                            </th>
                            <th class="p-8 text-center">
                                <p class="text-blue-600 font-extrabold text-xs uppercase mb-2">Avançado</p>
                                <a href="#" class="inline-block border border-blue-200 text-blue-600 px-6 py-2 rounded-full text-xs font-bold hover:bg-blue-50 transition-all">Fale conosco</a>
                            </th>
                        </tr>
                    </thead>
                    ...
                    <tbody class="category-content active" id="comms">
                        <tr class="border-t border-slate-100">
                            ...
                            <td class="p-4 text-center"><i data-lucide="check" class="mx-auto w-5 h-5 text-green-500"></i></td>
                            <td class="p-4 text-center"><i data-lucide="check" class="mx-auto w-5 h-5 text-green-500"></i></td>
                            <td class="p-4 text-center"><i data-lucide="check" class="mx-auto w-5 h-5 text-green-500"></i></td>
                        </tr>
                        <tr class="border-t border-slate-100">
                        ...
                        <tr class="border-t border-slate-100">
                         ...
                         <tr class="border-t border-slate-100">
                            ...
                            <td class="p-4 text-center"><i data-lucide="x" class="mx-auto w-5 h-5 text-red-400"></i></td>
                            <td class="p-4 text-center"><i data-lucide="x" class="mx-auto w-5 h-5 text-red-400"></i></td>
                            <td class="p-4 text-center"><span class="text-green-600 font-bold text-xs">INCLUSO</span></td>
                        </tr>
                    </tbody>
        ...
        <section class="max-w-4xl mx-auto px-4 reveal">
            <div class="bg-gradient-to-br from-[#0c46e6] to-[#00d2ff] p-16 rounded-[4rem] text-center text-white shadow-2xl relative overflow-hidden">
                <div class="absolute top-0 right-0 w-64 h-64 bg-white/10 rounded-full blur-3xl -mr-32 -mt-32"></div>
                <h2 class="text-4xl font-black mb-8 relative z-10">Revolucione sua escola hoje.</h2>
                <a href="#contato" class="inline-block bg-white text-[#0c46e6] px-12 py-5 rounded-2xl font-black text-lg hover:scale-105 transition-all shadow-xl shadow-white/10 relative z-10">Começar Agora</a>
            </div>
        </section>
