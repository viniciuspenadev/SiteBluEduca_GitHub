            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
                ...
                <div class="lg:col-span-5 flex flex-col items-center lg:items-start text-center lg:text-left">
                    ...
                    <h1
                        ...
                        <span id="typewriter-text"
                            ...
                            Uauuu! <img
                                src="assets/img/winking-smiley-face-emoji-expressing-playful-cheeky-feelings-digital-format.webp"
                    ...
                    <script>
                        document.addEventListener('DOMContentLoaded', function () {
                            ...
                            const words = [
                                ...
                                "Intuitiva.",
                                "Completa.",
                                'Uauuu! <img src="assets/img/winking-smiley-face-emoji-expressing-playful-cheeky-feelings-digital-format.webp" class="inline-block w-16 h-16 lg:w-24 lg:h-24 -mt-6 lg:-mt-10 ml-1 animate-bounce relative z-30" alt="Wow">'
                            ];
                ...
                <div
                    ...
                    <div class="relative z-10 w-full max-w-lg lg:max-w-xl mx-auto flex items-end h-full">
                        <img src="assets/img/surprised-young-man-green-shirt-holding-smartphone-transparent-background.webp"
